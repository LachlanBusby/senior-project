...
def binop_tree(expr1, op, expr2):
	return Tree("EXPR", children=[Tree("BIN_EXPR", children=[expr1, bin_operator_tree(op), expr2])])

def compop_tree(expr1, op, expr2):
	return Tree("EXPR", children=[Tree("COMP_EXPR", children=[expr1, comp_operator_tree(op), expr2])])
